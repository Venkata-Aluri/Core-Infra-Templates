...
def lambda_handler(event, context):
    ...
    for userlist in unique_user_list:
        ...
        for keyValue in userKeys['AccessKeyMetadata']:
            ...
            print(f"IAMUserName:{IAMUserName}")
...
# if Access key age is greater then or equal to 70 days, send warning
            if active_days == datetime.timedelta(days=int(os.environ['days_20'])):
                    ...
                    if(len(email_tag) == 1):
                        ...
                        print("This User: ", IAMUserName, ", with the email: ", email, ", is having access key age is 25 days") 
                    ...
                    if(len(email_tag) == 1):
                        ...
                        if(len(user1_tag) == 1):
                            ...
                            if user1tag == "Employee":
                                ...
                                key_pair=iam.create_access_key(UserName=IAMUserName)
                                print(key_pair)                       
                    ...
                    if(len(email_tag) == 1):
                        ...
                        if(len(user1_tag) == 1):
                            ...
                            if user1tag == "Employee":
                                iam.update_access_key(AccessKeyId=UserAccessKeyID,Status='Inactive',UserName=IAMUserName)
                                print("Status has been updated to Inactive")
                                #iam.create_access_key(UserName=IAMUserName)
                                #print(response)
